...
import com.example.composeexampleapp.data.locationList
...
class LocationsViewModel :ViewModel (){
    ...
    private fun getSuperHeroes(){
        viewModelScope.launch {
            val response = RetrofitBuilder.instance.getSuperHeroes(Constants.TS, Constants.API_KEY, Constants.HASH_KEY)
